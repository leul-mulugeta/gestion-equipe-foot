...
if (!isset($_GET['id']) || !ctype_digit($_GET['id'])) {
    ...
    if (!$rencontre) {
        ...
        $controleurParticipants = new ObtenirTousLesParticipantsDUneRencontre($rencontreId);
                        ...
                        <tbody>
                            <?php foreach ($participants as $participant): ?>
                                <tr>
                                    ...
                                    <td>
                                        <input type="number" name="evaluation[<?= $participant->getParticipantId() ?>]" min="1" max="5" value="<?= $participant->getEvaluation() ?>" required>
                                    </td>
                                </tr>
                            <?php endforeach; ?>
                        </tbody>
